...
const VPageDashboardPlaceFloorBodyChoose: React.FC<MComponentUsecasePlaceFloor.BodyChoose> = ({
    items,
    onChoose
}): JSX.Element => {
...
export default VPageDashboardPlaceFloorBodyChoose