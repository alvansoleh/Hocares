...
const VPageDashboardProfileFieldChangePasswordNewPassword: React.FC<MComponentUsecaseAuthProfile.FieldPassword> = ({
    value,
    onChange
}): JSX.Element => {
    ...
    return (<FormControl 
        ...
        <FormLabel fontSize={16} fontWeight={"semibold"} textColor={CUtilityColor.gray}>
            {CUtilityString.forms.password.label} Baru
        </FormLabel>
        <InputGroup>
            <InputLeftElement>
...
export default VPageDashboardProfileFieldChangePasswordNewPassword