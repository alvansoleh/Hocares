...
const VPageDashboardUsedAssetFormStatus: React.FC<MComponentGlobalSearch.OptionBy> = ({
    active_index,
    options,
    onSelect
}): JSX.Element => {
    ...
    return (<FormControl 
        ...
        <FormLabel fontSize={16} fontWeight={"semibold"} textColor={CUtilityColor.gray}>
            {`Out ${CUtilityString.forms.status.label}`}
        </FormLabel>
...
export default VPageDashboardUsedAssetFormStatus