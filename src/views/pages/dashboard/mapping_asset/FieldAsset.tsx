...
import { CUsecaseAsset, CUtilityColor, CUtilityString } from "controllers";
import { useEffect } from "react";
import { VComponentFormQuery, VComponentLoader, VComponentModal, VComponentTableBase } from "views/components";
import { VPageDashboardAssetBodyChoose, VPageDashboardAssetFilter, VPageDashboardAssetHead } from "../assets/index";

const VPageDashboardMappingAssetFormAsset: React.FC<MComponentUsecaseMappingAsset.Field> = ({
    value,
    onChange
}): JSX.Element => {
...
export default VPageDashboardMappingAssetFormAsset